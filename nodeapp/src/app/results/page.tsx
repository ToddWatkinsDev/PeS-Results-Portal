      ...
      <section className="overflow-hidden rounded-2xl border border-[color:var(--color-surface-2)] bg-[color:var(--color-surface)] shadow-sm">
        ...
        <div className="space-y-4 p-5">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="grid grid-cols-1 gap-3 rounded-xl border border-[color:var(--color-surface-2)] p-4 md:grid-cols-4 md:items-center"
            >
              <div className="h-5 w-40 rounded bg-[color:var(--color-surface-2)]" />
              <div className="h-5 w-56 rounded bg-[color:var(--color-surface-2)]" />
              <div className="h-5 w-24 rounded bg-[color:var(--color-surface-2)]" />
              <div className="h-5 w-20 rounded bg-[color:var(--color-surface-2)] md:justify-self-end" />
            </div>
          ))}
        </div>
      </section>
        ...
        {races.length > 0 ? (
          <section className="overflow-hidden rounded-2xl border border-[color:var(--color-surface-2)] bg-[color:var(--color-surface)] shadow-sm">
            ...
            {races.map((r) => (
              <div
                key={r.slug}
                className="grid grid-cols-1 gap-3 border-b px-5 py-4 text-sm text-[color:var(--color-text-muted)] transition-colors hover:bg-[color:var(--color-surface-2)] md:grid-cols-4 md:items-center"
              >
    ...
    return (
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-4 py-12 sm:px-6 lg:px-8">
        ...
        <EmptyState
          ...
          description="We could not load the public results right now. Please try again shortly."
          action={
            <Button asChild>
